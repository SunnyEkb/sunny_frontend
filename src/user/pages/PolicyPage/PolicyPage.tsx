...
const PolicyPage:FC = () => (
	<main className={styles.PolicyPage}>
		...
		<h2 className={styles.PolicyPage__title}>
			Политика в отношении обработки персональных данных
		</h2>
		<h3 className={styles.PolicyPage__paragraph}>1. Общие положения</h3>
		<p className= {styles.PolicyPage__text}>
		...
		<ul className={styles.PolicyPage__list}>
		...
		<h3 className={styles.PolicyPage__paragraph}>
		...
		<h3 className={styles.PolicyPage__paragraph}>12. Заключительные положения</h3>
		<ul className={styles.PolicyPage__list}>
			<li className={styles.PolicyPage__list_text}>
